...
class BacktestConfig:
    ...
    # Processing settings
    batch_size: int = 10
    max_workers: int = field(default_factory=lambda: os.cpu_count() or 4)  # Use max CPU cores
    ...
    def validate_dates(self) -> bool:
        ...
        return (self.historic_start_date <= self.analysis_start_date <= self.analysis_end_date)
